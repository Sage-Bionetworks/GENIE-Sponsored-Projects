...
1. Once you have completed all the steps above, in Github, create a pull request from the feature branch of your fork to the `develop` branch of Sage-Bionetworks/GENIE-Sponsored-Projects.  Make sure to add 'Fixes #<issue_number>' to the comment of your pull request to automatically link the issue.  
